...
import logo from "../public/d52b4ba4a12fc6d9511bce3e4066d533-Photoroom.png";
...
export default function Header() {
  ...
  return (
    <header className="bg-[#0d3d2f] text-white sticky top-0 z-50 shadow-lg overflow-visible">
